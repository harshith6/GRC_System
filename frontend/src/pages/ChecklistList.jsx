...
const ChecklistList = () => {
  ...
  const handleDeleteConfirm = async () => {
    try {
      ...
      setChecklists(
        checklists.filter((c) => c.id !== deleteConfirmModal.checklistId),
      );
      setDeleteConfirmModal({
        isOpen: false,
        checklistId: null,
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.data) {
        ...
        setFormErrors({
          general: "Failed to update checklist. Please try again.",
        });
      }
    } finally {
      setSubmitting(false);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {filteredChecklists.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Link
            to="/checklists/new"
            className="mt-4 inline-block text-gray-900 hover:text-gray-700 font-medium underline"
          >
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${checklist.completion_percentage || 0}%`,
                      }}
                    ></div>
                  </div>
                </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleStatusChange(e, checklist.id, checklist.status)
                    }
        ...
        <div className="space-y-4">
          <p className="text-gray-700">
            ...
            <span className="font-semibold">
              {deleteConfirmModal.checklistName}
            </span>
            ?
          </p>
          <p className="text-sm text-gray-600">
            This action cannot be undone. All items in this checklist will also
            be deleted.
          </p>
